...
from app.src.bookds.book_data import books
...
async def update_book(book_id:int,book_update_data:BookUpdaeModel)->dict:


    for book in books:
        if book["id"] == book_id:
            book["title"] = book_update_data.title
            book["publisher"]=book_update_data.pushisher
